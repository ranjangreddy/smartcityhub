...
import UserInterface.MedicalHelp.SpecificHospitalJPanel;
 ...
 * @author anirudh
 */
public class HospitalRepDahsboard extends javax.swing.JPanel {

    /**
     * Creates new form HospitalRepDahsboard
     */
    EcoSystem system;
    
    public HospitalRepDahsboard(EcoSystem system) {
        initComponents();
        this.system = system;
        
          //method for click-response action buttons
        ArrayList<JButton> buttonList = new ArrayList<>();
        buttonList.add(btnViewDet);
...
//        SpecificHospitalJPanel panel = new SpecificHospitalJPanel(system, hospital);
        HospitalRepViewJPanel panel = new HospitalRepViewJPanel(system);
